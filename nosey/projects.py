...
class Projects(object):
    ...
    def parseProjectFile(self, file):
        # test = [] #['H:/raw/alignment_00887', 'H:/raw/alignment_00888',
        # 'H:/raw/alignment_00889', 'H:/raw/alignment_00890']
        ...
        for b in blocks:
            ...
            for word in keywords:
                ...
                if 'SCANS' in b:
                    ...
                    for ind, a in enumerate(analyzers):
                        ...
                        d_1 = float(
                            re.findall(
                                kp.format('bg01-distance'),
                                a)[0])
                        d_2 = float(
                            re.findall(
                                kp.format('bg02-distance'),
                                a)[0])
                    ...
                    for ind, r in enumerate(references):
                        ...
                        References.addExternalReference(
                            self, event=None, paths=[path], include=include, setAsRef1=r1, setAsRef2=r2)
            ...
            for ind, value in enumerate(keywords.values()):
                msgBox.setText(
                    'Processing analysis and plotting options [{}]'.format(
                        value[0]))
